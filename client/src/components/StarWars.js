...
class StarWars extends React.Component {
  state = { characters: [], locations: [] } //state going to fill by axios with compDidMount

  //lifecycle method
  componentDidMount() {
    axios.get('/api/characters?nerd_type=starwars') //passing nerd type in bc there was logic to show a specific type
      .then( res => {
